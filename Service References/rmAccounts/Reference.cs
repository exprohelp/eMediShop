...
namespace eMediShop.rmAccounts {
    using System.Data;
    ...
    public interface Accounts_WebServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eMediShop.rmAccounts.GC_InsertDocumentInfoResponse GC_InsertDocumentInfo(eMediShop.rmAccounts.GC_InsertDocumentInfoRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eMediShop.rmAccounts.Insert_ConversationByDesktopAppResponse Insert_ConversationByDesktopApp(eMediShop.rmAccounts.Insert_ConversationByDesktopAppRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eMediShop.rmAccounts.App_Info_InsertResponse App_Info_Insert(eMediShop.rmAccounts.App_Info_InsertRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eMediShop.rmAccounts.DownloadFileResponse DownloadFile(eMediShop.rmAccounts.DownloadFileRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eMediShop.rmAccounts.TransferDocumentsResponse TransferDocuments(eMediShop.rmAccounts.TransferDocumentsRequest request);
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Accounts_WebServiceSoapClient : System.ServiceModel.ClientBase<eMediShop.rmAccounts.Accounts_WebServiceSoap>, eMediShop.rmAccounts.Accounts_WebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eMediShop.rmAccounts.GC_InsertDocumentInfoResponse eMediShop.rmAccounts.Accounts_WebServiceSoap.GC_InsertDocumentInfo(eMediShop.rmAccounts.GC_InsertDocumentInfoRequest request) {
        ...
        public string GC_InsertDocumentInfo(string UID, string doc_id, byte[] data, string extension, string doc_remark, string login_id, string Logic) {
            eMediShop.rmAccounts.GC_InsertDocumentInfoRequest inValue = new eMediShop.rmAccounts.GC_InsertDocumentInfoRequest();
            inValue.UID = UID;
            ...
            inValue.login_id = login_id;
            inValue.Logic = Logic;
            eMediShop.rmAccounts.GC_InsertDocumentInfoResponse retVal = ((eMediShop.rmAccounts.Accounts_WebServiceSoap)(this)).GC_InsertDocumentInfo(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eMediShop.rmAccounts.Insert_ConversationByDesktopAppResponse eMediShop.rmAccounts.Accounts_WebServiceSoap.Insert_ConversationByDesktopApp(eMediShop.rmAccounts.Insert_ConversationByDesktopAppRequest request) {
        ...
        public string Insert_ConversationByDesktopApp(string etype, string loginid, string recipientIds, string cc_tolist, string subject, string conversation, int SubjectId, string mail_type, byte[] data, string file_name) {
            eMediShop.rmAccounts.Insert_ConversationByDesktopAppRequest inValue = new eMediShop.rmAccounts.Insert_ConversationByDesktopAppRequest();
            inValue.etype = etype;
            ...
            eMediShop.rmAccounts.Insert_ConversationByDesktopAppResponse retVal = ((eMediShop.rmAccounts.Accounts_WebServiceSoap)(this)).Insert_ConversationByDesktopApp(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eMediShop.rmAccounts.App_Info_InsertResponse eMediShop.rmAccounts.Accounts_WebServiceSoap.App_Info_Insert(eMediShop.rmAccounts.App_Info_InsertRequest request) {
        ...
        public string App_Info_Insert(
                    ...
                    decimal igst, 
                    byte[] data) {
            eMediShop.rmAccounts.App_Info_InsertRequest inValue = new eMediShop.rmAccounts.App_Info_InsertRequest();
            ...
            inValue.igst = igst;
            inValue.data = data;
            eMediShop.rmAccounts.App_Info_InsertResponse retVal = ((eMediShop.rmAccounts.Accounts_WebServiceSoap)(this)).App_Info_Insert(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eMediShop.rmAccounts.DownloadFileResponse eMediShop.rmAccounts.Accounts_WebServiceSoap.DownloadFile(eMediShop.rmAccounts.DownloadFileRequest request) {
            return base.Channel.DownloadFile(request);
        }
        
        public byte[] DownloadFile(string Path, out string processInfo) {
            eMediShop.rmAccounts.DownloadFileRequest inValue = new eMediShop.rmAccounts.DownloadFileRequest();
            inValue.Path = Path;
            eMediShop.rmAccounts.DownloadFileResponse retVal = ((eMediShop.rmAccounts.Accounts_WebServiceSoap)(this)).DownloadFile(inValue);
            processInfo = retVal.processInfo;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eMediShop.rmAccounts.TransferDocumentsResponse eMediShop.rmAccounts.Accounts_WebServiceSoap.TransferDocuments(eMediShop.rmAccounts.TransferDocumentsRequest request) {
        ...
        public string TransferDocuments(string Doc_date, string Division, string Unit_Id, string FinYear, string FileType, string FileName, byte[] data, out string msg) {
            eMediShop.rmAccounts.TransferDocumentsRequest inValue = new eMediShop.rmAccounts.TransferDocumentsRequest();
            ...
            inValue.FileName = FileName;
            inValue.data = data;
            eMediShop.rmAccounts.TransferDocumentsResponse retVal = ((eMediShop.rmAccounts.Accounts_WebServiceSoap)(this)).TransferDocuments(inValue);
            msg = retVal.msg;
