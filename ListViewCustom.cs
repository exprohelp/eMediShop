...
public class ListViewCustom : ListView
    ...
    public event textBoxKeyUpEventHandler textBoxHandler;
    public event comboIndexChangeEventHandler comboChangeEventHandler;
    #region The RECT structure
		...
		private void InitializeComponent()
		{
            ...
            this.textBox.KeyUp += new System.Windows.Forms.KeyEventHandler(textBox_KeyUp); 
            // Combo box
		...
		/// </param>
        /// 
        public void AddComboBoxCell(int row, int col, object[] data)
		{
			// Add the cell into the hashtable
		...
		/// <param name="data"> Items of the combobox 
		/// </param>
		public void AddComboBoxCell( int row, int col, string[] param)
		{
			try
			{
		...
		private void ShowComboBox( Point location, Size sz,object[] data )
		{
			try
			{
            ...
            try
            {
                ...
                if (this.row != -1 && this.col != -1)
                {
                    ...
                    if (cell != null)
                    {
                        ...
                        {
                            this.ShowComboBox(location, sz,combodata);
                        }
                    }
                }
            }
		...
		/// <returns></returns>
        //private int GetDropDownWidth( object[] data )
        //{
        ...
        ///
        /// This use to Update the Information 
        ///
        ...
        private void textBox_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
               // MessageBox.Show(this.Items[row].SubItems[0].Text);
                textBoxKeyUpEventArgs obj = new textBoxKeyUpEventArgs(row, this.textBox.Text);
                textBoxHandler(this, obj);
            }
        }
		...
		private void combo_SelectedIndexChanged(object sender, EventArgs e)
		{
            try
			{
				if( this.row != -1 && this.col != -1 )
				{
                    ...
                    comboChangeEventArgs obj = new comboChangeEventArgs(row, ((eMediShop.ExproComboBox) this.combo.SelectedItem).Value);
                    comboChangeEventHandler(this,obj);
		...
		#endregion
        //Create Key UP event of TextBox
