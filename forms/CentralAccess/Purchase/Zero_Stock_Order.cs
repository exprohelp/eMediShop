...
namespace eMediShop
{
    public partial class Zero_Stock_Order : Telerik.WinControls.UI.RadForm
    {
        ...
        private void btnPreserve_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                datasetWithResult dwr = ConfigWebAPI.CallAPI("api/purchase/PurchaseMonthlyOrderForRetail", p);
        ...
        private void Preserve()
        {
            try
            {
                ...
                Cursor.Current = Cursors.WaitCursor;
                pm_PurchaseOrders p = new pm_PurchaseOrders();
                p.unit_id = GlobalUsage.Unit_id;p.prm_1 = "X";p.login_id = GlobalUsage.Login_id;
                datasetWithResult dwr = ConfigWebAPI.CallAPI("api/purchase/PurchaseGenerateOrders", p);
                _ds = dwr.result;
