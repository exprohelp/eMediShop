    ...
    public partial class UploadSubstitute_Control : UserControl
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              _result = GlobalUsage.pharmacy_proxy.Insert_Modify_Substitute_docs(GlobalUsage.Unit_id,_ItemId,_ItemName,System.IO.File.ReadAllBytes(txtpath.Text),"Insert");
               lblMsg.Text = _result;
